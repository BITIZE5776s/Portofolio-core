...
export const metadata: Metadata = {
  title: "Projects | Zakaria Mirinioui",
  metadataBase: new URL("https://zakaria-mirinioui.dev/projects"),
  description:
    "Explore enterprise-grade projects built by Zakaria Mirinioui - judicial systems, healthcare platforms, and secure logistics solutions",
  openGraph: {
    title: "Projects | Zakaria Mirinioui",
    url: "https://zakaria-mirinioui.dev/projects",
    description:
      "Explore enterprise-grade projects built by Zakaria Mirinioui - judicial systems, healthcare platforms, and secure logistics solutions",
    images: "/og.png",
  },
